...
main (int argc, char **argv)
{
  ...
  // none of the other arguments of sendto() specify which interface to use.		//interface index is required to bind a socket 
  											// to a desired interface	
